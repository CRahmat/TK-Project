...
namespace TK_Project.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [AllowAnonymous]
        public JsonResult IsValidNIK(string NIK)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var userNIK = await UserManager.FindByNameAsync(model.Email);
            if(user == null)
            {
                user = userNIK;
            }
            if (user == null && userNIK == null)
            {
        ...
        [AllowAnonymous]
        public async Task<ActionResult> NotConfirm()
        {
            return View();
        }
